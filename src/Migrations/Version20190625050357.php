 ...
 */
final class Version20190625050357 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE json_field (id INT AUTO_INCREMENT NOT NULL, parent_id INT DEFAULT NULL, json_schema_id INT UNSIGNED NOT NULL, name VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, format VARCHAR(255) DEFAULT NULL, required TINYINT(1) DEFAULT \'0\' NOT NULL, creation DATETIME NOT NULL, last_update DATETIME NOT NULL, INDEX IDX_5E2C8E17727ACA70 (parent_id), INDEX IDX_5E2C8E1794065426 (json_schema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
